            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <p class="">{{ $pizza->waiting_time }} Mins</p>
                    </div>
                    <h3 class="font-weight-semi-bold mb-4">{{ $pizza->price }} Ks</h3>
                    <h3 class="font-weight-semi-bold mb-4">view : {{ $pizza->view_count + 1 }}</h3>
                        ...
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="{{ route('pizza#details', $l->id) }}">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="text-dark mr-1">Wating Time</small>
                                    <small>{{ $l->waiting_time }} mins</small>
                                </div>
                            </div>
                        </div>
                    @endforeach
