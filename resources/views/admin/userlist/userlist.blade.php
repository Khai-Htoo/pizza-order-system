                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-1 offset-11  mb-3">
                                <h4><i class="fa-solid fa-coins text-warning"></i> : <span class=" text-secondary"></span>
                                </h4>
                            </div>
                        </div>
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td>
                                            <div class="table-data-feature" id="parents">
                                                <a href="{{ route('userlist#delete', $a->id) }}">
                                                ...
                                                <select name="role" class="form-control change col-6">


                                                    <option value="admin"
                                                        @if ($a->role == 'user') selected @endif>Admin
                                                    </option>
                                                    <option value="user"
